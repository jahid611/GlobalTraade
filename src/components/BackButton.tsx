...
export function BackButton() {
  ...
  return (
    <button
      onClick={goBack}
      aria-label="Retour"
      className="fixed top-5 left-4 sm:left-6 z-[95] w-10 h-10 sm:w-11 sm:h-11 rounded-full liquid-glass border border-white/15 bg-white/5 flex items-center justify-center text-white/70 hover:text-white hover:bg-white/15 transition-all backdrop-blur-xl shadow-lg group"
    >
