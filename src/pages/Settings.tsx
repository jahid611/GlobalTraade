...
export default function Settings() {
  ...
  const inputClass = "w-full bg-transparent border-b border-white/20 pb-[1vh] text-[clamp(1rem,1.2vw,1.25rem)] font-light text-white focus:outline-none focus:border-primary transition-colors placeholder:text-white/20 rounded-none px-0";
