...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        // Apple (Mac/iOS) -> vraie SF Pro via -apple-system ; partout ailleurs -> Instrument Sans (l'ancienne).
        sans: ['-apple-system', 'BlinkMacSystemFont', '"Instrument Sans"', '"Segoe UI"', 'Roboto', 'sans-serif'],
      }
    },
  },
